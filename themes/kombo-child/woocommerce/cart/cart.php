...
<div class="cart-wrapper">
    ...
    <div class="form-wrapper">
        <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
            ...
            ?>
                    <div class="woocommerce-cart-form__cart-item product-wrapper <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>" data-cart-key="<?php echo esc_attr($cart_item_key); ?>">
                        ...
                        <div class="product-body">
                            <div class="product-date">
                                ...
                                <div class="date" style="cursor: pointer;">
                                    <input type="text" class="cart-datepicker" style="display: none;">
                                        ...
                                        if (isset($cart_item['delivery_dates'])) {
                                            if (is_array($cart_item['delivery_dates'])) {
                                                ...
                                                if ($date_obj) {
                                                    ...
                                                    echo $cart_item['delivery_dates'];
                                                }
                                            }
                                        } else {
                                            echo 'Nije odabran datum';
                                        }
                                        ?>
                                    </span>
                                </div>
            ...
            <a
                href="<?php
                        ...
                        if ($current_language === 'sr') {
                            echo site_url() . '/placanje';
                        } elseif ($current_language === 'en') {
                            echo site_url() . '/payment';
                        } elseif ($current_language === 'ru') {
                            echo site_url() . '/оплата';
                        }
                        ?>"
                class="button-main">
